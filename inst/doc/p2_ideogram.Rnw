...
<<ideo-hg19, fig = TRUE, warning = FALSE, fig.width = 5, fig.height = 2, message = FALSE>>=
library(ggbio)
## requrie connection
...
<<fig = TRUE, fig.width = 5, fig.height = 2>>=
...
<<ideo-ori-xlabel, fig = TRUE, fig.width = 5, fig.height = 2>>=
...
<<ideo-ori-nocyto, fig = TRUE, fig.width = 5, fig.height = 2>>=
...
<<hg19-nocyto, fig = TRUE, fig.width = 5, fig.height = 2>>=
head(hg19Ideogram)
library(GenomicRanges)
## single ideogram
...
<<cyto-color, fig = TRUE, fig.width = 5, fig.height = 2>>=
